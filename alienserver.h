...
public:
    ...
    //   these objects are stored in this list, so that they can be accessed for whatever the fetish.
...
signals:
    ...
    // # sigServerError:
    //   emitted by this class when an error occurs.
...
public slots:
    ...
    //   prints a list of local network adapter interfaces available for use by your app.
